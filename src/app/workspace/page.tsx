        ...
        <div className="flex justify-center mt-2">
          <div className="flex items-center justify-center gap-2 sm:gap-4 bg-[#0a0a0a] p-2 rounded-2xl border border-zinc-800/80 w-full sm:w-auto flex-wrap sm:flex-nowrap">
            ...
            <Button 
                ...
                className="!px-3 !py-3 !bg-[#050505] !text-emerald-500/70 border-emerald-900/30 hover:!bg-emerald-500/10 hover:!text-emerald-400 rounded-xl shadow-none hover:shadow-[0_0_10px_rgba(52,211,153,0.2)]"
